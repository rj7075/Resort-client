...
const AddRoom = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      // converting amenities to array and keeping only enabled amenites
      const amenities = Object.keys(inputs.amenities).filter(
        (key) => inputs.amenities[key]
      );
      formData.append("amenities", JSON.stringify(amenities));
      //Adding in images to formData
  ...
  return (
    <form onSubmit={onSubmitHandler}>
      <TitleSubtitle
        ...
        font="outfit"
        title="Add Room"
        subTitle="Fill in the Details and carefully and accurate room details , pricing , and amenities to enhance the user 
        booking Expirience."
      />
